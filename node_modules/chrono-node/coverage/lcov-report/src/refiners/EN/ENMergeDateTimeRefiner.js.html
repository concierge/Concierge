...
<html lang="en">
<head>
    <title>Code coverage report for src/refiners/EN/ENMergeDateTimeRefiner.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/refiners/EN/ENMergeDateTimeRefiner.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">96.97% <small>(64 / 66)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/refiners/EN/</a> &#187; ENMergeDateTimeRefiner.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    if (dateResult.end != null || timeResult.end != null) {
        ...
        var endDate   = dateResult.end == null ? dateResult.start : <span class="branch-1 cbranch-no" title="branch not covered" >dateResult.end;            </span>
        var endTime   = timeResult.end == null ? <span class="branch-0 cbranch-no" title="branch not covered" >timeResult.start </span>: timeResult.end;
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (endTime.isCertain('meridiem')) {
            endDateTime.assign('meridiem', endTime.get('meridiem'));
        } else <span class="cstat-no" title="statement not covered" >if (beginTime.get('meridiem') != null) {</span>
<span class="cstat-no" title="statement not covered" >            endDateTime.imply('meridiem', endTime.get('meridiem'));</span>
        }
