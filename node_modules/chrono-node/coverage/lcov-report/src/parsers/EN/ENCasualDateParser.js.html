...
<html lang="en">
<head>
    <title>Code coverage report for src/parsers/EN/ENCasualDateParser.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/parsers/EN/ENCasualDateParser.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/parsers/EN/</a> &#187; ENCasualDateParser.js</div>
</div>
<div class="body">
...
&nbsp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (refMoment.hour() &gt; 6) {
                startMoment.add(-1, 'day');
            }
&nbsp;
...
&nbsp;
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (secondMatch == "morning") {
&nbsp;
