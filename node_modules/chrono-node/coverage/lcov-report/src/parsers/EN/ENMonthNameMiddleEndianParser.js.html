...
<html lang="en">
<head>
    <title>Code coverage report for src/parsers/EN/ENMonthNameMiddleEndianParser.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/parsers/EN/ENMonthNameMiddleEndianParser.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.05% <small>(79 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">98.68% <small>(75 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/parsers/EN/</a> &#187; ENMonthNameMiddleEndianParser.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    this.extract = function(text, ref, match, opt){ 
        ...
        if(match &amp;&amp; text.indexOf(match[0]) == 0){
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if(match[10]) <span class="cstat-no" title="statement not covered" >text = text.replace(match[10],'');</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if(!date) <span class="cstat-no" title="statement not covered" >return null;</span>
&nbsp;
...
&nbsp;
            text = text.replace(match[2], '');
            text = text.replace(match[4], match[4]+' ');
            <span class="missing-if-branch" title="else path not taken" >E</span>if(match[4]) text = text.replace(match[5],'');
            ...
            else <span class="missing-if-branch" title="if path not taken" >I</span>if( Math.abs(lastYear.diff(moment(ref))) &lt; Math.abs(date.diff(moment(ref))) ){ 
<span class="cstat-no" title="statement not covered" >                date = lastYear;</span>
            }
&nbsp;
            result.start.assign('day', date.date());
            result.start.assign('month', date.month() + 1);
