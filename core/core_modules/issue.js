...
var ifStringNotEmpty = function(str) {
    ...
    submitRequest = function(title, description, debugLevel, callback, waitCallback) {
        ...
        var stringToken = new Buffer(token, 'base64').toString('utf-8');
...
exports.help = function(commandPrefix) {
    return [
        [commandPrefix + 'issue "<title>" <debugLevel>',
        'Posts an issue to Github.',
        'Posts an issue to Github. DebugLevel can be basic, detail or full, defaults to basic if notspecified.'],
        [commandPrefix + 'issue "<title>" "<description>" <debugLevel>',
        'Posts an issue to Github with a description.',
        'Posts an issue to Github with a description. DebugLevel can be basic, detail or full, defaults to basic if not specified.']
    ];
};
